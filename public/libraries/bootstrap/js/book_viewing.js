       ...
       $('#book_view').on( 'click', function(e){
           ...
           e.preventDefault();
            ...
            if(!view_fullname || !view_email || !view_phone || !view_company_name || !view_company_address || !view_date || !view_time){
                setTimeout(function () { 
                                swal("Oops!" , "All fields are required and ever...","error");
                              }, 
                              1000);
            }else{
                 $.ajax({
                            ...
                            success: function(data){
                                  ...
                                  // alert(view_time);
                                  setTimeout(function () { 
                                  swal("Thank You!" , "for ajax Your bookin was successful, as we shall be expecting you on the specified date and time,","success");
                                });
                            },error:function(){
